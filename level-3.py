...
KfErkDaWMFZZeuqDmXKJEGHyToPUhPphfVhgUZg`bIuRAtWnroImpJKqqmEZqeNQCKzhjIkKQHURWLXFw
PBuijeoTSpsVLaOGuLVjMZXkBvVXwUuHfBihziiavGSYofPNeKsTXruMUumRRPQJzvSzJkKbtSipiqBd
"""

# 每个小字母两边都有三个大写的字母包围 like xXXXxXXXx
# 看网页标题，应该是用re正则表达式写

# pattern = re.compile(r'[a-z][A-Z]{3}[a-z][A-Z]{3}[a-z]')
# pattern = re.compile(r'[A-Z]{3}[a-z][A-Z]{3}', re.M)
...
t2 = str
list_aa = ['0' if c in string.ascii_lowercase else '1' for c in t2]
print(list_aa)
markers = ''.join(list_aa)
print(markers)
